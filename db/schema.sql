...
CREATE INDEX idx_admin_requests_requester ON public.admin_requests USING btree (requester_client_id);
CREATE INDEX idx_admin_requests_topic ON public.admin_requests USING btree (topic_id);
...
CREATE TABLE public.message_logs (
	...
	payload_preview varchar(100) NULL,
